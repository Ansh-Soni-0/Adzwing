...
export default function HeroSection() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <motion.h1
        className="text-3xl/17 md:text-5xl/21 font-medium max-w-6xl text-center"
        initial={{ y: 50, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        viewport={{ once: true }}
        transition={{ type: "spring", stiffness: 240, damping: 70, mass: 1 }}
      >
        Empowering brands with next-level digital 
        
        <div class="relative inline-block">
          <span class="text-outline smooth-crisp text-6xl font-extrabold tracking-tight select-none">
            Advertising
          </span>

          <span
            class="absolute left-0 top-0 bottom-0 reveal animate-fill-unfill"
            aria-hidden="true"
          >
            <span class="gradient-text smooth-crisp text-6xl font-extrabold tracking-tight select-none">
              Advertising
            </span>
          </span>
        </div>
      ...
      >
        We provide smart, impactful advertising solutions that help businesses
        reach the right audience, boost visibility, and grow faster.
      </motion.p>
      <motion.div
