...
export default function Advertiser() {
    return (
        <div id="advertiser" className="px-4 md:px-16 lg:px-24 xl:px-32">
            
            <SectionTitle text1="Advertiser" text2="Smart Advertising Solutions for Growth" text3="Boost your brand visibility with powerful, targeted digital advertising today." />
            ...
            className="flex flex-wrap w-full justify-around items-center">
                ...
                <div className="flex flex-wrap gap-6 md:gap-4 mt-16 px-6">
                {advertiser.map((feature, index) => (
                ...
                <button className="md:block px-9 py-4 bg-pink-600 hover:bg-pink-700 active:scale-95 transition-all rounded-full mr-50 mt-15">
                    <Link to={"/register"}>
                        Join Us Today
                    </Link>
                </button>
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our advertising solutions combine creativity and strategy to promote your business and drive real performance.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Reach more customers with powerful ads.</h3>
                        <p className="text-slate-300 mt-2">Delivering ads that engage, convert, and accelerate growth.</p>
